...
- Asegurar consistencia entre OMS centralizado / Orquestador de Pedidos (APP-02), WMS Principal (On Premises) (APP-06), TMS (Transportation Management) (APP-11), App de Conductores (APP-15), portales, ERP Financiero (On Premises) (APP-25) y analítica.
...
- INT-08: Debe minimizarse el acoplamiento directo entre WMS Principal (On Premises) (APP-06), TMS (Transportation Management) (APP-11), app móvil, portales y ERP Financiero (On Premises) (APP-25).
