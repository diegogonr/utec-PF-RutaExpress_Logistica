...
- Azure se prioriza para APIs, OMS centralizado / Orquestador de Pedidos (APP-02), TMS (Transportation Management) (APP-11) y gobierno de integración porque el caso ya ubica Azure API Management (APP-01), AKS y TMS (Transportation Management) (APP-11) en Azure.
...
- Azure API Management (APP-01): gateway de APIs, políticas, rate limiting, OAuth, versionamiento y publicación de contratos.
...
- Azure SQL Database / SQL Managed Instance: datos transaccionales del OMS centralizado / Orquestador de Pedidos (APP-02), catálogos operativos y estados canónicos.
