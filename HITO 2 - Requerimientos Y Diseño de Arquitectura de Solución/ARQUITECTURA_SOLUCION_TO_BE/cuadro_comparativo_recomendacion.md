...
|---|---:|---:|---|
| Alineamiento con Hito 1 | 5 | 3 | A mantiene OMS centralizado / Orquestador de Pedidos (APP-02)/API/TMS/eventos en el eje Azure ya descrito y conserva AWS/GCP en sus dominios actuales. |
| Cobertura RF/RNF INI-01 | 5 | 4 | Ambas cubren OMS centralizado / Orquestador de Pedidos (APP-02) e inventario, pero A reduce puentes entre OMS centralizado / Orquestador de Pedidos (APP-02), API governance y bus. |
...
| Complejidad de integracion | 4 | 3 | A requiere bridges AWS/GCP; B requiere puente permanente Azure OMS centralizado / Orquestador de Pedidos (APP-02) -> AWS hub y doble gobierno API/eventos. |
...
| Observabilidad | 5 | 4 | A facilita trazas end-to-end desde OMS centralizado / Orquestador de Pedidos (APP-02)/eventos; B necesita federacion mas intensa CloudWatch/Azure/GCP. |
...
| Facilidad de MVP con API mock | 5 | 4 | A permite publicar mocks y contratos desde Azure API Management (APP-01) junto al OMS centralizado / Orquestador de Pedidos (APP-02). |
