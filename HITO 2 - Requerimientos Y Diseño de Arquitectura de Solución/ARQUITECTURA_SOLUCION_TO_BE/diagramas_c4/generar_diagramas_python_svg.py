    ...
    return {
        ...
        "alternativa-b-n2": DiagramSpec(
            ...
            [
                ...
                Lane("Azure", "azure", [
                    ("apim", "Gateway y Gobierno API\nAzure API Management (APP-01)"),
                    ("oms", "OMS centralizado / Orquestador de Pedidos (APP-02) e Inventario\nAPP-02 sobre AKS"),
                    ("sql", "Repositorio transaccional\nAzure SQL"),
                    ("tms", "Adaptador TMS (Transportation Management) (APP-11)\nAPP-11"),
                    ("azobs", "Telemetria Azure"),
                ]),
                Lane("AWS", "aws", [
                    ("eventhub", "Hub eventos principal\nEventBridge Bus de Eventos Central (PLT-03)"),
                    ("queues", "Colas, DLQ y Replay\nSQS + workers"),
                    ("adapters", "Adaptadores validadores\nLambda/ECS"),
                    ("backend", "Backend movil\nECS/Lambda"),
                    ("syncdb", "Repositorio sync movil\nDynamoDB"),
                    ("s3", "Repositorio evidencias\nS3 + KMS"),
                    ("awsobs", "Telemetria AWS"),
                ]),
                Lane("GCP", "gcp", [
                    ("pubsub", "Canal analitico\nPub/Sub"),
                    ("opt", "Optimizador dinamico\nCloud Run/GKE"),
            ...
            [
                ...
                ("oms", "sql", "estado"),
                ("oms", "eventhub", "bridge"),
                ("oms", "wms", "WMS Principal (On Premises) (APP-06)"),
                ("oms", "erp", "ERP Financiero (On Premises) (APP-25)"),
                ("eventhub", "queues", "ruteo"),
                ("queues", "adapters", "consume"),
                ("adapters", "tms", "despacho"),
                ("adapters", "portal", "estado"),
                ("adapters", "legacy", "adaptador"),
                ("app", "backend", "mobile"),
                ("backend", "syncdb", "estado"),
                ("backend", "s3", "evidencia"),
                ("backend", "eventhub", "events"),
                ("eventhub", "pubsub", "bridge"),
                ("pubsub", "opt", "eventos"),
                ("opt", "dwh", "features"),
                ("dwh", "ml", "modelo"),
                ("ops", "awsobs", "dashboards"),
        ...
        "alternativa-b-n3": DiagramSpec(
            ...
            "Zoom a un unico contenedor: Hub principal de eventos Bus de Eventos Central (PLT-03) en AWS.",
            [
                Lane("Productores", "external", [
                ...
                Lane("Consumidores", "external", [
                    ...
                    ("portal", "Portal B2B / CRM"),
                    ("optimizer", "Optimizador GCP"),
                    ("obs", "Observabilidad federada"),
                    ("iam", "AWS IAM / Secrets"),
                ]),
            ],
            [
                ("apim", "oms", "contratos"),
                ("oms", "ingest", "Order/Inventory"),
                ("mobile", "ingest", "Tracking"),
                ("legacy", "ingest", "Legacy"),
                ("ingest", "schema", "valida"),
                ("schema", "rules", "valido"),
                ("rules", "queues", "fanout"),
                ("queues", "ordering", "secuencia"),
                ("ordering", "retry", "entrega"),
                ("retry", "tms", "eventos"),
                ("retry", "portal", "estado"),
                ("retry", "optimizer", "analitica"),
