...
- WMS Principal (On Premises) (APP-06) principal on premises sobre SQL Server.
- TMS (Transportation Management) (APP-11) en Azure.
...
- Todos los requerimientos de las carpetas `HITO 2 - Requerimientos Y Diseño de Arquitectura de Solución/INI-01_*`, `HITO 2 - Requerimientos Y Diseño de Arquitectura de Solución/INI-02_*` y `HITO 2 - Requerimientos Y Diseño de Arquitectura de Solución/INI-03_*`.
- Todos los lineamientos de la carpeta `lineamientos/`.
- La volumetría del archivo `contexto/volumetria.md`.
- La casuística de `Caso 6a - Ruta Express_Logistica.md` y `Caso 6b - Ruta Express_Logistica - Anexo.md`.
- Los entregables solicitados en `Enunciado del Proyecto Integrador Final.md`.
...
- `HITO 2 - Requerimientos Y Diseño de Arquitectura de Solución/INI-01_*`
- `HITO 2 - Requerimientos Y Diseño de Arquitectura de Solución/INI-02_*`
- `HITO 2 - Requerimientos Y Diseño de Arquitectura de Solución/INI-03_*`
...
2. Diagramas de secuencia:
   ...
   - Los diagramas deben cubrir escenarios positivos y negativos relevantes de esa iniciativa:
     - INI-01: orden válida, pedido duplicado, reserva de inventario, inventario insuficiente, degradación de WMS Principal (On Premises) (APP-06) y conciliación de inventario.
...
3. Alternativas de arquitectura de solución TO BE:
   - Usa como entrada principal todos los RF/RNF, historias y criterios de aceptación consolidados en:
     - `HITO 2 - Requerimientos Y Diseño de Arquitectura de Solución/INI-01_*/01_Requerimientos_y_Criterios_Aceptacion.md`
     - `HITO 2 - Requerimientos Y Diseño de Arquitectura de Solución/INI-02_*/01_Requerimientos_y_Criterios_Aceptacion.md`
     - `HITO 2 - Requerimientos Y Diseño de Arquitectura de Solución/INI-03_*/01_Requerimientos_y_Criterios_Aceptacion.md`
   - Usa además las historias detalladas y escenarios Gherkin completos desde:
     - `HITO 2 - Requerimientos Y Diseño de Arquitectura de Solución/INI-01_*/historias_gherkin/*.md`
     - `HITO 2 - Requerimientos Y Diseño de Arquitectura de Solución/INI-02_*/historias_gherkin/*.md`
     - `HITO 2 - Requerimientos Y Diseño de Arquitectura de Solución/INI-03_*/historias_gherkin/*.md`
   ...
   - Aplica los lineamientos de arquitectura, integración, seguridad, observabilidad, escalabilidad y stack tecnológico definidos en `lineamientos/`.
   ...
   - Genera:
     - `HITO 2 - Requerimientos Y Diseño de Arquitectura de Solución/ARQUITECTURA_SOLUCION_TO_BE/02_Alternativa_A.md`
     - `HITO 2 - Requerimientos Y Diseño de Arquitectura de Solución/ARQUITECTURA_SOLUCION_TO_BE/02_Alternativa_B.md`

4. Cuadro comparativo y recomendación:
   - Genera `HITO 2 - Requerimientos Y Diseño de Arquitectura de Solución/ARQUITECTURA_SOLUCION_TO_BE/cuadro_comparativo_recomendacion.md`.
...
5. Diagrama de arquitectura cloud transversal:
   - Genera `HITO 2 - Requerimientos Y Diseño de Arquitectura de Solución/ARQUITECTURA_SOLUCION_TO_BE/diagrama_arquitectura.md`.
...
6. Decisiones de diseño:
   - Genera `HITO 2 - Requerimientos Y Diseño de Arquitectura de Solución/ARQUITECTURA_SOLUCION_TO_BE/decisiones_diseño.md`.
   - Incluye todas las decisiones de diseño tomadas como Architectural Decision Records (ADR).
   - Incluye ADR principales sobre: Bus de Eventos Central (PLT-03), estrategia OMS centralizado / Orquestador de Pedidos (APP-02), idempotencia, patrón store-and-forward, DLQ, observabilidad, seguridad, datos de inventario, sincronización móvil, gobierno multinube, C4 seleccionado, integración con sistemas on premises, gestión de secretos, trazabilidad, costos y FinOps.
