...
| Caso 6b - Riesgo 3 | Texto libre, categorias distintas y cambios manuales sin causa estructurada | Las excepciones deben ser canonicas y trazables entre app, TMS (Transportation Management) (APP-11), CRM y portal |
...
- Taxonomia unica de excepciones para app, TMS (Transportation Management) (APP-11), CRM y portal.
...
| RF-06 | Funcional | El sistema debe aplicar una taxonomia unica de excepciones. | App, TMS (Transportation Management) (APP-11), CRM y portal usan los mismos codigos y descripciones oficiales. |
...
| RF-12 | Funcional | La app debe registrar y sincronizar eventos de ubicacion cada 2 minutos cuando exista conectividad, y encolar eventos cuando opere offline. | TMS (Transportation Management) (APP-11) y portal reciben eventos con secuencia, timestamp original y estado de sincronizacion. |
...
| HU-INI03-RF06 | Logistica | responsable de atencion y transporte | una taxonomia unica de excepciones | que app, TMS (Transportation Management) (APP-11), CRM y portal usen los mismos codigos y descripciones | RF-06 |
