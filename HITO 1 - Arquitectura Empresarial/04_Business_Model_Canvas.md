...
│   (1,400 unidades   │   órdenes de clientes │ cobertura nacional,  │ • Portal web B2B                     │
...
│                     │ • 2,700 vehículos     │   confiable desde    │ • Portal de visibilidad              │
...
### 3. Canales
Multicanal para integración: API para grandes, portal web para medianos, archivos para legacy. La app de conductores es el canal de ejecución en campo. El portal de tracking es el canal de visibilidad para destinatarios y clientes.
