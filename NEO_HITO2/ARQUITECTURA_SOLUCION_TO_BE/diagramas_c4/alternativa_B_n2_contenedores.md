...
> Regla aplicada: AWS concentra el hub principal de eventos y ultima milla; Azure conserva APIs, OMS y TMS; GCP conserva optimizacion y analitica.
...
1. El cliente entra por Azure API Management y las solicitudes llegan al OMS e Inventario desplegado en Azure.
2. El OMS persiste en Azure SQL, consulta WMS/ERP cuando corresponde y publica eventos hacia el hub principal en AWS.
...
5. Los adaptadores publican estados hacia TMS, Portal/CRM y canales legados.
...
| OMS e Inventario | Azure AKS | Ordenes, validacion, deduplicacion, reservas y conciliacion. |
