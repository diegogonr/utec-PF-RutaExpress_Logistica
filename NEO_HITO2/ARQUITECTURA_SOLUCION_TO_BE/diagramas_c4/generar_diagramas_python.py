...
def alternativa_a_n3_componentes() -> None:
    """C4 Componentes: zoom a un solo contenedor, PLT-03 en Azure."""
...
def alternativa_b_n3_componentes() -> None:
    """C4 Componentes: zoom a un solo contenedor, PLT-03 en AWS."""
    with _diagram("alternativa_B_n3_componentes", "TB"):
        ...
        with Cluster("Contenedor en foco: Hub principal de eventos PLT-03"):
