...
| Cajas de Sistemas externos | Sistemas que interactuan con RutaExpress: WMS, TMS, ERP, Portal/CRM, canales legados y servicios de mapas. |
...
3. La plataforma interactua con WMS para inventario, TMS para despacho/rutas, ERP para valorizacion/liquidacion y Portal/CRM para trazabilidad y atencion.
